...
const TILES = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1518604666860-9ed391f76460?w=1000&q=80",
  },
  {
    title: "The Playmakers",
    caption: "Signature editions from top scorers",
    image:
      "https://images.unsplash.com/photo-1552667466-07770ae110d0?w=1000&q=80",
  },
  {
        ...
        {TILES.map((t) => (
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 p-6 md:p-8 text-canvas">
              ...
              <h3 className="mt-2 font-display text-3xl md:text-4xl uppercase leading-none">
                {t.title}
              </h3>
