...
export default function CheckoutPage({ params }: PageProps) {
  ...
  // Accordion open/close state for checkout steps
  const [activeStep, setActiveStep] = useState<number>(1);

  // Hardcoded mockup data matching the provided design image
  const orderItems = [
    {
      id: "item-1",
  ...
  // Helper formatting for currency (Taka symbol ৳)
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        ...
        <div className="lg:col-span-7 xl:col-span-8 space-y-4">
          ...
          <div className="bg-canvas border border-hairline-soft rounded-xl overflow-hidden transition-all duration-300">
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-ink text-canvas flex items-center justify-center text-xs font-bold font-sans">
                  1
                </div>
                <span className="text-sm font-bold text-ink uppercase tracking-wider font-sans">
                  Shipping Address
                </span>
              </div>
              {activeStep === 1 ? (
            ...
            {/* Step Content */}
            {activeStep === 1 && (
              <div className="px-5 pb-6 pt-2 border-t border-hairline-soft/60 space-y-4 animate-in fade-in duration-300">
                {/* Full Name & Phone Number */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <CommonInput 
                    label="Full Name" 
                    placeholder="Enter your full name" 
                    defaultValue="Rifat Ahmed" 
                  />
                  <CommonInput 
                    label="Phone Number" 
                ...
                <CommonInput 
                  ...
                  defaultValue="rifat.ahmed@example.com" 
                />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <CommonInput 
                    ...
                    defaultValue="House 12, Road 5, Dhanmondi" 
                  />
                  <CommonInput 
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-3">
                  ...
                  <Button 
                    ...
                    className="rounded-full bg-ink hover:bg-charcoal text-canvas px-6 py-2.5 text-xs font-semibold uppercase tracking-wider transition-colors cursor-pointer self-end sm:self-auto border-none h-11 shadow-sm"
                  >
          ...
          <div className="bg-canvas border border-hairline-soft rounded-xl overflow-hidden transition-all duration-300">
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-ink/10 text-ink/60 dark:bg-ink/20 dark:text-ink/80 flex items-center justify-center text-xs font-bold font-sans">
                  2
                </div>
                <span className="text-sm font-bold text-ink/60 uppercase tracking-wider font-sans">
                  Delivery Method
                </span>
              </div>
              {activeStep === 2 ? (
            ...
            {activeStep === 2 && (
              <div className="px-5 pb-6 pt-4 border-t border-hairline-soft/60 animate-in fade-in duration-300">
                <p className="text-xs text-mute font-sans">Delivery options will appear here.</p>
              </div>
            )}
          </div>
          ...
          <div className="bg-canvas border border-hairline-soft rounded-xl overflow-hidden transition-all duration-300">
            ...
            {activeStep === 3 && (
              <div className="px-5 pb-6 pt-4 border-t border-hairline-soft/60 animate-in fade-in duration-300">
                <p className="text-xs text-mute font-sans">Payment integrations will appear here.</p>
              </div>
            )}
          </div>
          ...
          <div className="bg-canvas border border-hairline-soft rounded-xl overflow-hidden transition-all duration-300">
            ...
            {activeStep === 4 && (
              <div className="px-5 pb-6 pt-4 border-t border-hairline-soft/60 animate-in fade-in duration-300">
                <p className="text-xs text-mute font-sans">Review your items and place order.</p>
              </div>
            )}
          </div>
        ...
        <div className="lg:col-span-5 xl:col-span-4 lg:sticky lg:top-24 space-y-4">
          ...
          <div className="bg-canvas border border-hairline-soft rounded-xl p-6 shadow-sm">
            ...
            <div className="flex items-baseline justify-between border-b border-hairline-soft pb-4">
              <h2 className="text-base font-bold uppercase tracking-wider text-ink font-sans">
                Order Summary
              </h2>
            ...
            <div className="divide-y divide-hairline-soft/50 max-h-[350px] overflow-y-auto pr-1">
              {orderItems.map((item) => (
                <div key={item.id} className="flex items-center gap-4 py-4 first:pt-3 last:pb-3">
            ...
            <div className="border-t border-hairline-soft pt-4 pb-2 space-y-2.5">
              ...
              <div className="flex items-center justify-between text-xs font-sans">
                <span className="text-[#0f766e] dark:text-emerald-400">Discount</span>
