          ...
          <div className="bg-canvas border border-hairline-soft rounded-xl overflow-hidden transition-all duration-300">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className={`text-base font-display font-normal uppercase tracking-wider ${
            ...
            {/* Step Content */}
            {activeStep === 1 && (
              <form onSubmit={handleSubmit(onSubmit)} className="px-5 pb-6 pt-2 border-t border-hairline-soft/60 space-y-4 animate-in fade-in duration-300">
