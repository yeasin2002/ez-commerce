            ...
            >
              ...
              <div className="flex items-center gap-4">
                <div className="flex gap-1.5 shrink-0">
                  ...
                  <div className="w-10 h-10 rounded border border-hairline bg-cloud/50 dark:bg-zinc-900 flex items-center justify-center overflow-hidden">
                    <svg
                      viewBox="0 0 100 100"
                      className="w-7 h-7 fill-ink/65 dark:fill-canvas/75 select-none pointer-events-none"
                    >
              ...
              <div className="flex items-center justify-between sm:justify-end gap-6 mt-3 sm:mt-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <IconChevronRight
                    size={14}
                    className="text-mute group-hover:text-ink dark:group-hover:text-canvas transition-colors hidden sm:block"
                  />
                </div>
              </div>
            </Link>
