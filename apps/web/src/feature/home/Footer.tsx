import { IconBrandInstagram, IconBrandTwitter, IconBrandYoutube, IconBrandFacebook } from "@tabler/icons-react";

const COLS = [
  {
    title: "Shop",
    links: ["New Arrivals", "Best Sellers", "National Teams", "Club Kits", "Retro", "Accessories"],
  },
  {
    title: "Help",
  ...
  {
    title: "Company",
    links: ["About", "Sustainability", "Press", "Careers", "Affiliates", "Wholesale"],
  },
];
    ...
    <footer className="border-t border-hairline-soft bg-canvas pt-16">
      <div className="container-page">
        <div className="grid gap-12 md:grid-cols-[1.5fr_repeat(3,1fr)]">
          <div>
            <span className="font-display text-3xl tracking-wider">FOOTY<span className="text-mute">STYLE</span>HUB</span>
            <p className="mt-4 max-w-xs text-sm text-mute">
              The home of authentic football kits, retro classics, and everything the game wears.
            </p>
            <div className="mt-6 flex gap-2">
              {[IconBrandInstagram, IconBrandTwitter, IconBrandYoutube, IconBrandFacebook].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-4 border-t border-hairline-soft py-8 md:flex-row md:items-center">
          <p className="text-xs text-mute">© {new Date().getFullYear()} FootyStyleHub. All rights reserved.</p>
